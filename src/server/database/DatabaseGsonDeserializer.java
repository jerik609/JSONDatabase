...
public class DatabaseGsonDeserializer implements JsonDeserializer<Database<String>> {
    @Override
    public Database<String> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
